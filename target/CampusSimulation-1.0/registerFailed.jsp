...
<html>
    ...
    <body>
        <div id="succeed" class="container d-flex align-items-center justify-content-center">
            <div id="login-row">
                <div class="title text-center mb-3">
                    <h1> The user already exists in our database </h1>
                    <p class="text-black-50 mb-3">You can chose another one... try again</p>
                </div>
